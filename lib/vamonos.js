...
(function() {
  ...
  this.Vamonos = {
    ...
    formatObject: function(object, attributes) {
      var attribute, rows, tbl;
      if (attributes == null) {
        attributes = [];
      }
      tbl = "<table>";
      rows = (function() {
        ...
        for (_i = 0, _len = attributes.length; _i < _len; _i++) {
          ...
          _results.push(("<tr><td>" + attribute + "</td><td>&nbsp=&nbsp") + Vamonos.rawToTxt(object[attribute]) + "</td></tr>");
        }
        return _results;
      })();
      tbl += rows.join("") + "</table>";
...
(function() {
  ...
  BinaryTree = (function() {
    ...
    BinaryTree.description = "*Experimental*. BinaryTree takes a tree encoded as nested objects of " + "the form `{ val, id, left, right }` where left and right are optional " + "objects of the same form.";
...
(function() {
  ...
  Graph = (function() {
    ...
    Graph.description = "The Graph data structure provides standard graph functionality " + "to Vamonos. You can use it in your algorithms, or inside widgets.";
    ...
    Graph.prototype.addEdge = function(source, target, attrs) {
      ...
      if (!this.directed) {
        return ((_ref1 = (_base1 = this.edges)[targetId]) != null ? _ref1 : _base1[targetId] = {})[sourceId] = edge;
      }
    };
    ...
    Graph.prototype.incomingEdges = function(v) {
      var edge, outgoingEdges, source, target, uglyArray, vid, _ref;
      vid = this.idify(v);
      uglyArray = (function() {
        var _ref, _results;
        _ref = this.edges;
...
(function() {
  ...
  Visualizer = (function() {
    ...
    Visualizer.description = "The central object of the Vamonos system. The Visualizer controls " + "the flow of information to and from Widgets, keeps track of " + "namespaces and variables, and runs the simulation itself.";
...
(function() {
  ...
  Array = (function() {
    ...
    function Array(options) {
      ...
      options.tableContainer = $("<table>", {
        "class": "array"
      });
      this.$container.append(options.tableContainer);
...
(function() {
  ...
  ArrayGuts = (function() {
    ...
    function ArrayGuts(args) {
      ...
      this.$cells = [];
      this.$annotations = [];
      this.tableContainer.append(this.$rowIndices, this.$rowCells, this.$rowAnnotations);
    ...
    ArrayGuts.prototype.event = function() {
      ...
      switch (event) {
        ...
        case "displayStart":
          if (this.displayOnly) {
            _ref5 = [this.$rowIndices, this.$rowCells, this.$rowAnnotations];
  ...
  GraphDisplay = (function() {
    ...
    GraphDisplay.spec = {
      ...
      edgeLabel: {
        type: "Array",
        defaultValue: [],
        description: "an array, containing the name of the edge attribute to display" + "and the default value for new edges.",
        example: "edgeLabel: [ 'w', 1 ]"
      },
      colorEdges: {
        type: "Array",
        defaultValue: [],
    ...
    function GraphDisplay(args) {
      this.createEdgeLabel = __bind(this.createEdgeLabel, this);

      this.resetConnectionStyle = __bind(this.resetConnectionStyle, this);
      Vamonos.handleArguments({
        widgetObject: this,
        givenArgs: args
      });
    ...
    GraphDisplay.prototype.fitGraph = function(graph, animate) {
      var height, max_x, max_y, nodes, vertex, width, xVals, yVals, _i, _len, _ref;
      if (animate == null) {
        animate = false;
      }
      if (!this.graphDrawn) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        vertex = _ref[_i];
        xVals.push(vertex.x + width + this.containerMargin);
        yVals.push(vertex.y + height + this.containerMargin);
      }
      max_x = Math.max.apply(Math, __slice.call(xVals).concat([this.minX]));
      max_y = Math.max.apply(Math, __slice.call(yVals).concat([this.minY])) + (this.$drawer != null ? this.$drawer.height() : 0);
      if (animate) {
        this.$outer.animate({
          width: max_x,
          height: max_y
    ...
    GraphDisplay.prototype.updateNodeLabels = function($node, vertex, frame) {
      ...
      for (type in _ref) {
        ...
        $target.html(typeof style === "function" ? Vamonos.rawToTxt(style(vertex)) : style.length ? ((function() {
          ...
          return _results;
        })()).join(",") : typeof style === "object" ? Vamonos.rawToTxt(style[this.mode](vertex)) : style);
      }
    };
    ...
    GraphDisplay.prototype.addConnection = function(edge) {
      var con, _base, _base1, _name, _name1, _ref, _ref1, _ref2;
      if ((_ref = this.connections[edge.source.id]) != null ? _ref[edge.target.id] : void 0) {
        return;
      }
      ...
      ((_ref1 = (_base = this.connections)[_name = edge.source.id]) != null ? _ref1 : _base[_name] = {})[edge.target.id] = con;
      if (!this.directed) {
        ((_ref2 = (_base1 = this.connections)[_name1 = edge.target.id]) != null ? _ref2 : _base1[_name1] = {})[edge.source.id] = con;
      }
      return con;
    };
    ...
    GraphDisplay.prototype.removeConnection = function(sourceId, targetId) {
      var connection, _ref;
      if (!(connection = (_ref = this.connections[sourceId]) != null ? _ref[targetId] : void 0)) {
        return;
      }
    ...
    GraphDisplay.prototype.updateConnections = function(graph, frame) {
      ...
      this.eachConnection(function(sourceId, targetId, con) {
        return _this.resetConnectionStyle(con);
      });
      _ref = this.colorEdges;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    GraphDisplay.prototype.resetConnectionStyle = function(c) {
      return c != null ? c.setPaintStyle(this.normalPaintStyle) : void 0;
    };

    GraphDisplay.prototype.setOverlays = function(connection, edge) {
      var _ref,
        _this = this;
      ...
      if ((((_ref = this.edgeLabel) != null ? _ref[0] : void 0) != null) && (edge != null)) {
        return connection.addOverlay([
          "Custom", {
            create: function() {
              return _this.createEdgeLabel(edge);
            },
            id: "edgeLabel"
          }
        ]);
    ...
    GraphDisplay.prototype.createEdgeLabel = function(edge) {
      var $label, val, _ref;
...
(function() {
  ...
  Graph = (function() {
    ...
    function Graph(args) {
      ...
      var a, k, v, _i, _len, _ref, _ref1, _ref2;
      Vamonos.handleArguments({
        widgetObject: this,
        givenArgs: args,
        ignoreExtraArgs: true
      });
      this.edgeLabel = args.edgeLabel;
      ...
      _ref2 = ["varName", "defaultGraph", "inputVars"];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        a = _ref2[_i];
        delete args[a];
      }
    ...
    Graph.prototype.stopEditing = function() {
      this.deselect();
      this.displayWidget.mode = void 0;
      this.unsetConnectionEditBindings();
      this.unsetContainerEditBindings();
      this.updateVariables();
      return this.displayWidget.clearDisplay();
    };
    ...
    Graph.prototype.registerVariables = function() {
      ...
      for (key in this.inputVars) {
        _results.push(this.viz.registerVariable(key, true));
      }
      return _results;
    };
    ...
    Graph.prototype.updateVariables = function() {
      ...
      for (k in _ref) {
        ...
        if (v != null) {
          ...
          _results.push(console.log("GRAPH WIDGET: please set " + k + "!"));
        }
      }
      return _results;
    };

    Graph.prototype.addVertex = function(vertex, autoSelect) {
      var newv, node;
      if (vertex == null) {
        vertex = {};
      }
    ...
    Graph.prototype.addEdge = function(sourceId, targetId) {
      ...
      this.displayWidget.draw(this.theGraph, this.inputVars);
      return this.connectionBindings(this.displayWidget.connections[sourceId][targetId]);
    };
    ...
    Graph.prototype.setContainerEditBindings = function() {
      ...
      return this.displayWidget.$outer.on("click.vamonos-graph", function(e) {
        var $target, sourceId, targetId, x, y, _ref, _ref1;
        $target = $(e.target);
        if (!_this.selected()) {
          if ($target.is("div.vertex-contents")) {
            _this.selectNode($target.parent());
    ...
    Graph.prototype.unsetConnectionEditBindings = function() {
      ...
      return this.displayWidget.eachConnection(function(sourceId, targetId, con) {
        ...
        return con.showOverlay("edgeLabel");
      });
    };
    ...
    Graph.prototype.openDrawer = function() {
      var buttons, edge, label, nametag, sourceId, targetId, type, v, vtx,
        _this = this;
      type = this.selected();
      if (type === 'vertex') {
        ...
        for (v in this.inputVars) {
          buttons.push($("<button>", {
            ...
            _this.inputVars[v] = vtx;
            return _this.displayWidget.draw(_this.theGraph, _this.inputVars);
          }));
        }
        buttons.push($("<button>", {
          text: "del",
        ...
        nametag = edge.source.name + "&nbsp;" + (this.theGraph.directed ? "&rarr;" : "-") + "&nbsp;" + edge.target.name;
        label = "edge&nbsp;&nbsp;" + nametag + "&nbsp;&nbsp;";
        buttons = [
          $("<button>", {
            text: "del",
...
(function() {
  ...
  VarDisplay = (function() {
    ...
    VarDisplay.prototype.showVars = function(frame, type) {
      var dup, newval, oldval;
      if (!(frame[this.varName] != null)) {
        newval = "-";
      } else if (this.attributes != null) {
        newval = Vamonos.formatObject(frame[this.varName], this.attributes);
        this.dontShowChange = true;
      } else {
        newval = Vamonos.rawToTxt(frame[this.varName]);
      }
      oldval = this.$container.html();
      if (newval !== oldval && __indexOf.call(this.showChanges, type) >= 0) {
        if (!this.dontShowChange) {
          this.$container.addClass("changed");
        }
        this.$container.html(newval);
      ...
      return this.dontShowChange = void 0;
    };
