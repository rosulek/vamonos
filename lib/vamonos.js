...
(function() {
  ...
  Graph = (function(_super) {
    ...
    function Graph(_args) {
      var a, k, v, _base, _base1, _base2, _base3, _base4, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      this._args = _args;
      ...
      if ((_ref6 = (_base3 = this._args.edgeCssAttributes).potential) == null) {
        _base3.potential = function(edge) {
          return edge._potential;
        };
      }
      if ((_ref7 = (_base4 = this._args.edgeCssAttributes).selected) == null) {
        _base4.selected = function(edge) {
          return edge._selected;
        };
      }
      this.edgeLabel = (_ref8 = (_ref9 = this._args.edgeLabel) != null ? _ref9.edit : void 0) != null ? _ref8 : this._args.edgeLabel;
