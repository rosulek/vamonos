...
(function() {
  ...
  Graph = (function() {
    ...
    Graph.prototype.nextVertexId = function() {
      ...
      _ref1 = this.getVertices();
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        existingVtx = _ref1[_i];
        newId = "" + ((_ref2 = this.prefix) != null ? _ref2 : "custom-") + "vertex-" + (this._customVertexNum++);
    ...
    Graph.prototype.edgeId = function(e) {
      return e.source.id + (this.directed ? "-arr-" : "-bi-") + e.target.id;
    };
...
(function() {
  ...
  GraphDisplay = (function() {
    ...
    function GraphDisplay(args) {
      ...
      this.svg = d3.selectAll("#" + this.$outer.attr("id")).append("svg").attr("width", "100%").attr("height", "100%");
    ...
    GraphDisplay.prototype.event = function() {
      var done, event, klass, label, options, test, v, values, viz, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      event = arguments[0], options = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      switch (event) {
        case "setup":
          viz = options[0], done = options[1];
    ...
    GraphDisplay.prototype.fitGraph = function(animate) {
      var max_x, max_y, vertex, xVals, yVals, _i, _len, _ref;
      if (animate == null) {
        animate = false;
      }
      ...
      if (animate) {
        ...
        return this.$outer.height(max_y);
      }
    };
    ...
    GraphDisplay.prototype.startDragging = function(graph) {
      ...
      dragmove = function(d) {
        ...
        d.x = d3.event.x;
        d.y = d3.event.y;
        d3.select(this).attr('transform', trans).classed("vertex-drag", true);
    ...
    GraphDisplay.prototype.updateVertexLabels = function(sel) {
      var style, target, type, _ref, _ref1,
        _this = this;
      _ref = this.vertexLabels;
      for (type in _ref) {
        style = _ref[type];
        target = sel.selectAll("text." + (function() {
          switch (type) {
            case "inner":
        ...
        target.data(function(d) {
          return [d];
        });
        if (style.constructor.name === "Function") {
          target.html(function(d) {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(edges.each(function(e) {
          ...
          if ((res != null ? res.length : void 0) === 2) {
            ...
            styles.push(attr);
            return d3.select(this).style(attr, val);
          } else {
            _results1 = [];
            for (_j = 0, _len1 = styles.length; _j < _len1; _j++) {
              attr = styles[_j];
              _results1.push(d3.select(this).style(attr, null));
            }
            return _results1;
          }
        }));
    ...
    GraphDisplay.prototype.updateVertexClasses = function(vertexGroups) {
      ...
      vertices = vertexGroups.selectAll("ellipse.vertex").data(function(d) {
        ...
        return _this.highlightChanges && _this.mode === 'display' && _this.vertexChanged(vertex);
      });
...
(function() {
  ...
  Graph = (function(_super) {
    ...
    function Graph(_args) {
      var a, k, v, _base, _base1, _base2, _base3, _base4, _base5, _base6, _i, _len, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      this._args = _args;
      ...
      _ref = ["defaultEdgeAttrs", "showChanges", "varName", "defaultGraph", "inputVars", "editable"];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        a = _ref[_i];
        delete this._args[a];
      }
      ...
      if ((_ref6 = (_base3 = ((_ref7 = (_base4 = this._args).edgeCssAttributes) != null ? _ref7 : _base4.edgeCssAttributes = {})).potential) == null) {
        _base3.potential = function(edge) {
          return edge._potential;
        };
      }
      if ((_ref8 = (_base5 = ((_ref9 = (_base6 = this._args).edgeCssAttributes) != null ? _ref9 : _base6.edgeCssAttributes = {})).selected) == null) {
        _base5.selected = function(edge) {
          return edge._selected;
        };
      }
      this.edgeLabel = (_ref10 = (_ref11 = this._args.edgeLabel) != null ? _ref11.edit : void 0) != null ? _ref10 : this._args.edgeLabel;
      Graph.__super__.constructor.call(this, this._args);
    }
    ...
    Graph.prototype.event = function() {
      ...
      switch (event) {
        case "setup":
          ...
          return Graph.__super__.event.call(this, "setup", this.viz, done);
        case "render":
          frame = options[0], type = options[1];
    ...
    Graph.prototype.startEditing = function() {
      this.draw(this.theGraph, this.inputVars);
      if (this.editable) {
    ...
    Graph.prototype.setEditBindings = function() {
      ...
      this.inner.selectAll("g.vertex").classed("editable-vertex", true).on("click.vamonos-graph", function(d) {
        ...
        if ((sourceId != null) && (_this.theGraph.edge(sourceId, targetId)._potential != null)) {
      ...
      return this.$outer.on("click.vamonos-graph", function(e) {
        ...
        if (_this._notNewVertexClick) {
          ...
          x = e.offsetX - _this.containerMargin;
          y = e.offsetY - _this.containerMargin;
          return _this.addVertex({
            x: x,
            y: y
          });
    ...
    Graph.prototype.openDrawer = function() {
      var arr, attrName, buttons, defaultVal, edge, label, nametag, sourceId, targetId, type, v, vtx, _fn, _fn1, _ref,
        _this = this;
      type = this.selected();
      if (type === 'vertex') {
        ...
        _fn = function(v, vtx, buttons, ths, inputVars, theGraph) {
          ...
          $b.on("click.vamonos-graph", function(e) {
            inputVars[v] = vtx;
            return ths.draw(theGraph, inputVars);
          });
        ...
        buttons = [];
        _ref = this.defaultEdgeAttrs;
        _fn1 = function(edge, attrName, buttons, ths, inputVars, theGraph) {
          var $label, $val,
            _this = this;
          $val = $("<span>", {
            text: edge[attrName]
        ...
        for (attrName in _ref) {
          defaultVal = _ref[attrName];
          _fn1(edge, attrName, buttons, this, this.inputVars, this.theGraph);
          continue;
        }
        buttons.push($("<button>", {
          text: "del",
...
(function() {
  ...
  ResultProperty = (function() {
    ...
    ResultProperty.prototype.event = function() {
      var done, event, options, vFunc, vName, view, _ref, _results;
      event = arguments[0], options = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      if (event === 'setup') {
        this.viz = options[0], done = options[1];
        if (done != null) {
